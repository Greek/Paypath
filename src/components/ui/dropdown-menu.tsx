...
const dropdownMenuShortcutVarients = cva(
  `inline-block ml-2 py-0.5 px-1.5 text-xs w-5 tracking-widest opacity-60 rounded-sm text-center justify-center`,
  {
    variants: {
      variant: {
        default: "bg-neutral-600 dark:bg-gray-300",
        secondary: "bg-neutral-300 dark:bg-gray-600",
      },
    },
  }
);
...
export interface DropdownMenuShortcutProps
  extends React.HTMLAttributes<HTMLSpanElement>,
    VariantProps<typeof dropdownMenuShortcutVarients> {}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn(dropdownMenuShortcutVarients({ variant, className }))}
      {...props}
    />
  );
};
