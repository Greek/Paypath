...
export default function StorePortalModule({
  ...
  const { data: licenses } = useQuery(["me"], {
    queryFn: async () => {
      return (
        await axios.get(`/api/me/licenses?store=${params.name}&active=true`)
      ).data as License[];
    },
  });
    ...
    <>
      <LargeCard>
          ...
          <div className="min-h-[20rem] h-full p-5">
            <div className="space-y-3">
              {licenses
                ...
                : null}
              {licenses.length < 1 && (
                <div className="py-[40%] flex items-center justify-center text-center text-xs text-neutral-500">
                  <p>
                    You don&apos;t have any active licenses
                    <br /> from this store.
                  </p>
                </div>
              )}
        ...
        <div className="space-y-5">
          ...
          {!selectedLicense && (
            <>
              <div className="py-[50%] flex items-center justify-center text-xs text-neutral-500">
                <p>Nothing here.</p>
              </div>
            </>
          )}
