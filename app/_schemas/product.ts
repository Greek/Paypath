...
export const ProductModel = z.object({
  ...
  name: z
    .string()
    .min(1, { message: "Your product name cannot be empty." })
    .max(32, { message: "Your product can't be longer than 32 characters." }),
  ...
  price: z
    .string()
    .min(1, { message: "Your product's price cannot be empty." })
    .nullish(),
