...
export const StoreModel = z.object({
  ...
  name: z
    .string()
    .min(1, { message: "Your store name can't be empty." })
    .max(32, {
      message: "Your store name can't be longer than 32 characters.",
    }),
  description: z.string().max(256, {
    message: "Your description can't be longer than 256 characters.",
  }),
 ...
 */
export const RelatedStoreModel: z.ZodSchema<CompleteStore> = z.lazy(() =>
  StoreModel.extend({
